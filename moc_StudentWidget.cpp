...
**
** Created: Mon Oct 17 11:49:54 2011
...
static const char qt_meta_stringdata_StudentWidget[] = {
    "StudentWidget\0\0update()\0"
};

const QMetaObject StudentWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StudentWidget,
      qt_meta_data_StudentWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StudentWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StudentWidget))
